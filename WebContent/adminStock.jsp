...
%>
  	   ...
  	   <tr> <td><img src="./ShowImage?prodId=<%=product.getProdId()%>"  style="width:50px;height:50px;"></td> <td><a href="./updateProduct.jsp?prodid=<%=product.getProdId()%>"><%=product.getProdId() %></a></td><td><%=product.getProdName() %></td> 
