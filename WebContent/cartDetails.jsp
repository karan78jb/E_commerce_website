...
%>
  	   ...
  	   <tr> <td><img src="./ShowImage?prodId=<%=product.getProdId()%>"  style="width:50px;height:50px;"></td> <td><%=product.getProdName() %></td> 
     				...
     				<td>
                        <!--//             <a href="cartDetails.jsp?add=0&uid=<%=userName %>&pid=<%= product.getProdId()%>"><i class="fa fa-minus"></i></a>-->
     				 <form action="./UpdateToCart">
                                              <input type="hidden" name="pqty" value="0" style="max-width:70px;" min="0">
                                                <input type="hidden" name="pid" value="<%= product.getProdId()%>">
                                                <input type="submit" name="update" value="Remove" style="max-width:90px;">
                                            </form> 
                                </td>
     				<td><%=currAmount %></td>
		</tr>  		
