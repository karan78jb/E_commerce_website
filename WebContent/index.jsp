...
//  	products = prodDao.getAllProducts();
  	for(ProductBean product : products){
  		...
  		if(isValidUser){
  			...
  			addToCartUrl = "loginFirst.jsp";
  			buyNowUrl = "loginFirst.jsp";
  		}
  ...
  <div class="col-sm-4">
    <div class="thumbnail">
      <img src="./ShowImage?prodId=<%=product.getProdId() %>" alt="Product" style="height:200px; max-width:200px; max-width:300px;">
...
if(name!=null){
out.print("<h4>");
out.print("Succsessfully massage send");
out.print("</h4>");
}
  %>
