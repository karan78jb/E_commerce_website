...
public class MailMessage {
	public void registrationSuccess(String emailId,String name){
	...
	public void transactionSuccess(String recipientEmail,String name,String transId,double transAmount) {
	...
	public void productAvailableNow(String recipientEmail,String name,String prodName, String prodId) {
		String recipient = recipientEmail;
